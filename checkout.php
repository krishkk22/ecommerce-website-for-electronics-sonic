   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" placeholder="enter your number" class="box" type="tel" required pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" />
      ...
      <a href="order.php"><input type="submit" name="order" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="place order"></a>
